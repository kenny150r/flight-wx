/*! Vendored ESM build of bz2 (C) 2019-present SheetJS LLC — https://github.com/SheetJS/bz2 */

'use strict';

const bz2Api = (function bz2() {
...
export function decompress(data, crc) {
  return bz2Api.decompress(data, crc);
}
